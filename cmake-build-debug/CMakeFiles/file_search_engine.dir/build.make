...
file_search_engine.exe: CMakeFiles/file_search_engine.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=D:\projects\file_search_engine\cmake-build-debug\CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "Linking CXX executable file_search_engine.exe"
	$(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\file_search_engine.dir\link.txt --verbose=$(VERBOSE)
	D:\CMake\bin\cmake.exe -D TEST_TARGET=file_search_engine -D TEST_EXECUTABLE=D:/projects/file_search_engine/cmake-build-debug/file_search_engine.exe -D TEST_EXECUTOR= -D TEST_WORKING_DIR=D:/projects/file_search_engine/cmake-build-debug -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D TEST_FILTER= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=file_search_engine_TESTS -D CTEST_FILE=D:/projects/file_search_engine/cmake-build-debug/file_search_engine[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -D TEST_XML_OUTPUT_DIR= -P D:/CMake/share/cmake-3.29/Modules/GoogleTestAddTests.cmake
